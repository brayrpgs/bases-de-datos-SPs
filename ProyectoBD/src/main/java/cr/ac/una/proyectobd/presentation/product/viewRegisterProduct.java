...
public class viewRegisterProduct extends javax.swing.JFrame {
    ...
    private void uploadCB() {
        ...
        listSupplier.add("Seleccione un proveedor");
        listSupplier.add("Proveedor 1");
        listSupplier.add("Proveedor 2");
        listSupplier.add("Proveedor 3");

        DefaultComboBoxModel<String> cbModel = new DefaultComboBoxModel<>();
        // Agregar elementos al modelo
        for (String supplier : listSupplier) {
            cbModel.addElement(supplier);
        }
        ...
        listCategory.add("Categoria 1");
        listCategory.add("Categoria 2");
        listCategory.add("Categoria 3");

        DefaultComboBoxModel<String> cbModelCategory = new DefaultComboBoxModel<>();
        // Agregar elementos al modelo
        for (String category : listCategory) {
            cbModelCategory.addElement(category);
        }
        // Establecer el modelo en el JComboBox
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,cbCategory.getSelectedIndex());
            if (name.trim().isEmpty() || description.trim().isEmpty() || supplier.trim().isEmpty() || price <= 0
                    || category.trim().isEmpty() || quantity <= 0 || urlImage.trim().isEmpty() || 
